  ...
  try {
    ...
    for (const item of danhSachNhanVienVaKPI) {
      ...
      const monthlyData = [
        ...
        { month: '08', rate: 1.0, amount: kpiBonus, quota: kpiBonus, hq: 0 },
        { month: '09', rate: 1.0, amount: kpiBonus, quota: kpiBonus, hq: 0 },
        { month: '10', rate: 1.0, amount: kpiBonus, quota: kpiBonus, hq: 0 },
        { month: '11', rate: 1.0, amount: kpiBonus, quota: kpiBonus, hq: 0 },
        { month: '12', rate: 1.0, amount: kpiBonus, quota: kpiBonus, hq: 0 }
      ];
